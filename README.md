...
Modern, ölçeklenebilir ve production-grade web arayüzleri geliştiriyorum.  
React/Next.js ekosisteminde component mimarisi, veri yönetimi, UI tutarlılığı ve performans optimizasyonu üzerine uzmanlaştım.  
Önceliğim: temiz mimari, ölçülebilir performans, tahmin edilebilir kod akışı.
